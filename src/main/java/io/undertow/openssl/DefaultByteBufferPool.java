...
class DefaultByteBufferPool {
    ...
    static final DefaultByteBufferPool DIRECT_POOL = new DefaultByteBufferPool(true, Integer.getInteger("io.undertow.openssl.buffer-size", 17 * 1024));
    static final DefaultByteBufferPool INDIRECT_POOL = new DefaultByteBufferPool(false, Integer.getInteger("io.undertow.openssl.buffer-size", 17 * 1024));
